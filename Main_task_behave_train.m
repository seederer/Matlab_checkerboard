...
%% get subject info
prompt = {'Subject', 'Session' ,'Block', 'Sex', 'Hand', 'Age', 'task type: foc (1-6) div (7) and fixation (8)'};

%fill in some stock answers to the gui input boxes
defAns = {'1','1', '1' , 'm',  'r', '18', '1'};
...
fName=[p.root, '/Subject_Data/MainTask_behavtrain' num2str(p.tasktype) '_sbj', num2str(p.subNum), '_sess', num2str(p.sessType), '_block', num2str(p.runNum), '.mat'];
if exist(fName,'file')
    Screen('CloseAll');
